...
final Color primaryColor = Color(0xFF43F4AF);
final Color secondaryColor = Color(0xFF139461);
final Color whiteColor = Color(0xFFF1F1F1);
final Color blackColor = Color(0xFF212121);
